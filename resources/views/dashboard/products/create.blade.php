...
<div class="col-lg-8 ms-4 mt-5">
    <form action="/dashboard/products" method="post" class="mb-4" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('benefits') is-invalid @enderror" id="benefits" name="benefits" required autofocus value="{{ old('benefits') }}">
            @error('benefits')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
